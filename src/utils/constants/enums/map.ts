export enum MapStyles_old {
    ...
    "Satellite Streets" = "mapbox://styles/mapbox/satellite-streets-v11?optimize=true",
    Streets = "mapbox://styles/mapbox/streets-v11?optimize=true",
    "Navigation Day" = "mapbox://styles/mapbox/navigation-day-v1?optimize=true",
